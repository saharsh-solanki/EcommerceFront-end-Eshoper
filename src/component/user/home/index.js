...
function Body() {
  ...
  const [siteDetailApiLoader, setSiteDetailApiLoader] = React.useState(true);
  ...
  React.useEffect(async () => {
    ...
    // console.log(siteDetailApiLoader);
  }, []);
  ...
  return (
    <div>
      ...
      <div className="container-fluid pt-5">
        <div className="row px-xl-5 pb-3">
          {siteDetail.top_category
            ? siteDetail.top_category.map((category) => {
                return (
                          ...
                          src={
                            typeof category.icon === "string"
                              ? process.env.REACT_APP_BACKEND_API_URL +
                                category.icon.slice(1, category.icon.length)
                              : // console.log(typeof category.icon === "string")
                                process.env.PUBLIC_URL + "img/cat-1.jpg"
                          }
                          alt
                        />
                      </a>
