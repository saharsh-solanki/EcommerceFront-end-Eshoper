  ...
  return (
    <div>
                  ...
                  <div className="col-lg-4 col-md-6 pb-1">
                    ...
                    >
                      ...
                      >
                        <img
                          className="img-fluid"
                          src={GetConvertedImage(category.icon)}
                          alt
                        />
                      </a>
      ...
      <div className="container-fluid pt-5">
        ...
        <div className="row px-xl-5 pb-3">
          {siteDetail.trandy_product
            ? siteDetail.trandy_product.map((product) => {
      ...
      <div>
        ...
        <div className="container-fluid pt-5">
          ...
          <div className="row px-xl-5 pb-3">
            {siteDetail.latest_product
              ? siteDetail.latest_product.map((product) => {
                  return <SingleProduct product={product}></SingleProduct>;
                })
              : "Loading"}
          </div>
